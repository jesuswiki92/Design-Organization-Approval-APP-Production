...
| Doc | Contenido |
|-----|-----------|
| [Guía del project](docs/01-guia-proyecto.md) | Mapa de carpetas, tecnología, estructura |
| [Bases de datos](docs/02-bases-de-datos.md) | Inventario de tablas Supabase |
| [Flujo de requests](docs/03-flujo-consultas.md) | Los 3 statuses del flujo principal |
...
| [Observability Fase 1](docs/07-observability.md) | Evento canónico `doa_app_events`, helpers y cobertura inicial |
