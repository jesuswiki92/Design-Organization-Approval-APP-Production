...
export default function PortfolioError({
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 bg-[linear-gradient(180deg,#f8fbff_0%,#eef6ff_42%,#f8fasc_100%)] text-slate-900">
      <div className="flex flex-col items-center gap-3 rounded-[22px] border border-amber-200 bg-white p-8 shadow-[0_10px_24px_rgba(148,163,184,0.12)]">
        ...
        <h2 className="text-base font-semibold text-slate-950">No se pudo cargar el portfolio</h2>
