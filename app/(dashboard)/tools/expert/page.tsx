...
const SUGGESTED_QUESTIONS = [
  'Resume los pasos para prepare una quotation DOA para un client new.',
  'Que statuses de project deberiamos usar para un expediente de certificacion?',
  'Ayudame a redactar una response inicial para una solicitud technical de client.',
]

const WELCOME_MESSAGE =
  'Asistente DOA con OpenRouter. Puedo ayudarte con quotations, statuses de project, procedimientos y soporte operativo general.'
  ...
  async function sendQuestion(question: string) {
    ...
    try {
      ...
      if (!response.ok || !response.body) {
        ...
        throw new Error(payload?.error || 'No se pudo obtener response del asistente.')
      }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[color:var(--ink-3)]">
                  Chat directo para soporte operativo, quotations y statuses de project.
                </p>
              </div>
            </div>
            ...
            {messages.length === 1 && (
              <div className="rounded-[24px] border border-dashed border-[color:var(--ink-4)] bg-[color:var(--paper-2)]/50 p-6">
                <p className="max-w-2xl text-sm leading-7 text-[color:var(--ink-3)]">
                  Formula una request operativa sobre quotations, statuses de project, procesos
                  DOA o ayuda de redaccion. Esta version es un chat directo con OpenRouter y no
                  request base de data ni documents internos.
                </p>
          ...
          <div className="border-t border-[color:var(--ink-4)] px-6 py-5">
            ...
            <div className="rounded-[24px] border border-[color:var(--ink-4)] bg-[color:var(--paper-2)]/80 p-3 shadow-sm">
              <Textarea
                ...
                placeholder="Escribe tu request para el asistente DOA..."
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                <p className="text-xs text-[color:var(--ink-3)]">
                  Enter para send. Shift + Enter para new linea.
                </p>
        ...
        <aside className="flex min-h-[320px] flex-col overflow-hidden rounded-[28px] border border-[color:var(--ink-4)] bg-[color:var(--paper)] shadow-[0_18px_45px_rgba(148,163,184,0.16)]">
          ...
          <div className="flex-1 space-y-4 overflow-y-auto px-5 py-5">
            <article className="rounded-[22px] border border-[color:var(--ink-4)] bg-[color:var(--paper-2)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--ink-3)]">Model</div>
              ...
              <p className="mt-2 text-sm leading-6 text-[color:var(--ink-3)]">
                Response conversacional general para soporte DOA, quotations y projects.
              </p>
            </article>
            ...
            <article className="rounded-[22px] border border-[color:var(--ink-4)] bg-[color:var(--paper-2)] p-4">
              ...
              <ul className="mt-3 space-y-2 text-sm leading-6 text-[color:var(--ink-3)]">
                ...
                <li>Ayuda de redaccion y estructuracion inicial de responses.</li>
                <li>No request base de data ni documents internos todavia.</li>
              </ul>
            </article>
