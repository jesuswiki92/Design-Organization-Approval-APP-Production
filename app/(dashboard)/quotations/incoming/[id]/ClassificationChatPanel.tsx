          ...
          <div className="flex flex-1 flex-col">
            {logEntries.length > 0 && (
              <div className="flex justify-end px-3 pt-2">
                <button
                  onClick={onClearLog}
                  className="flex items-center gap-1 rounded px-2 py-1 text-[10px] font-medium text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600"
                >
              ...
              <div className="flex flex-1 flex-col">
                <div className="flex items-center gap-2 border-b border-slate-100 px-3 py-2">
                  <button
                    ...
                    className="flex items-center gap-1 rounded px-1.5 py-1 text-[10px] font-medium text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700"
                  >
                    <ArrowLeft className="h-3 w-3" />
                    Volver
                  </button>
                  <span className="text-xs font-medium text-slate-700">Borrador de email</span>
                </div>
                ...
                {emailSent ? (
                  <div className="flex flex-1 flex-col items-center justify-center gap-3 p-6">
                    ...
                    <button
                      ...
                      className="mt-2 rounded-lg border border-slate-200 px-4 py-2 text-xs font-medium text-slate-600 transition-colors hover:bg-slate-50"
                    >
                      Volver al chat
                    </button>
                  </div>
                    ...
                    <div className="space-y-3 p-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-700 focus:border-sky-300 focus:outline-none focus:ring-1 focus:ring-sky-200"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 font-mono text-xs leading-relaxed text-slate-700 focus:border-sky-300 focus:outline-none focus:ring-1 focus:ring-sky-200"
              ...
              <>
                <div className="flex items-center justify-between border-b border-slate-100 px-3 py-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 rounded-md border border-indigo-200 bg-indigo-50 px-2 py-1 text-[10px] font-medium text-indigo-600 transition-colors hover:bg-indigo-100 disabled:opacity-50"
                  >
                    {generatingEmail ? (
                      <>
                        <Loader2 className="h-3 w-3 animate-spin" />
                  ...
                  {chatMessages.length === 0 ? (
                    ...
                    chatMessages.map((msg, idx) => {
                      ...
                      return (
                        ...
                        >
                          {isAssistant && (
                            <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-sky-200 bg-sky-50 text-sky-600">
                          ...
                          {!isAssistant && (
                            <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500">
                ...
                <div className="border-t border-slate-100 p-3">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700 placeholder-slate-400 focus:border-sky-300 focus:outline-none focus:ring-1 focus:ring-sky-200 disabled:opacity-50"
                    />
                    <button
