        ...
        <div className="space-y-5">
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_rgba(148,163,184,0.12)]">
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-2">
              ...
              <DataField label="Año" icon={<CalendarDays className="h-3.5 w-3.5" />} value={anio} />
            </div>
          </section>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_rgba(148,163,184,0.12)]">
            ...
            <div className="mt-5 grid gap-3">
              <DataField label="Carpeta de origen" icon={<FolderOpen className="h-3.5 w-3.5" />} value={project.nombre_carpeta_origen} />
              <DataField label="Ruta de origen" icon={<FileText className="h-3.5 w-3.5" />} value={project.ruta_origen} />
            </div>
          </section>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_rgba(148,163,184,0.12)]">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3.5">
                <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-400">Fecha de creacion</span>
                <p className="mt-1.5 text-sm text-slate-900">{fechaCreacion || '—'}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3.5">
                <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-400">Ultima actualizacion</span>
                <p className="mt-1.5 text-sm text-slate-900">{fechaActualizacion || '—'}</p>
              </div>
            </div>
          </section>

          <section className="rounded-[28px] border border-sky-100 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_46%,#f8fafc_100%)] p-6 shadow-[0_18px_40px_rgba(14,165,233,0.08)]">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
              ...
              <li className="rounded-2xl border border-sky-100 bg-white/80 px-4 py-3">
                Documentos, notas y trazabilidad adicional.
              </li>
            </ul>
          </section>
        </div>
