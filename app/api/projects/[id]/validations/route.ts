...
/**
 * GET — Lista las validaciones de un project ordenadas por date DESC.
 * Enriquece cada fila con `validator_email` (via auth.admin.getUserById,
 * usando el admin client). Si la request admin falla, el email queda null
 * pero la validation se devuelve igualmente.
 */
export async function GET(
  ...
  // table directamente consultable por el client SSR normal).
