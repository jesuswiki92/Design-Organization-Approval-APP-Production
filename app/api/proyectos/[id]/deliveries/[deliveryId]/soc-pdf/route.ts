/**
 * GET /api/proyectos/[id]/deliveries/[deliveryId]/soc-pdf  — Sprint 3
 * Redirige (302) a una signed URL fresca del PDF SoC almacenado en Storage.
 * Auth requerida: solo usuarios de la organizacion pueden ver el PDF.
 */
...
export async function GET(
  ...
  if (!id || !deliveryId) {
    return jsonResponse(400, { error: 'proyecto_id y deliveryId requeridos.' })
  }
