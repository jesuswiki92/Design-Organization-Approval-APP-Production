...
const QUOTATION_BOARD_DEFAULT_ROWS: WorkflowStateConfigRow[] = [
  ...
  {
    scope: WORKFLOW_STATE_SCOPES.QUOTATION_BOARD,
    state_code: QUOTATION_BOARD_STATES.FORMULARIO_ESPECIFICO_ENVIADO,
    label: QUOTATION_BOARD_STATE_CONFIG.formulario_especifico_enviado.label,
    short_label: QUOTATION_BOARD_STATE_CONFIG.formulario_especifico_enviado.shortLabel,
    description: QUOTATION_BOARD_STATE_CONFIG.formulario_especifico_enviado.description,
    color_token: 'cyan',
    sort_order: 43,
    is_system: true,
    is_active: true,
  ...
  {
    scope: WORKFLOW_STATE_SCOPES.QUOTATION_BOARD,
    state_code: QUOTATION_BOARD_STATES.DEFINIR_ALCANCE_FINAL,
    label: QUOTATION_BOARD_STATE_CONFIG.definir_alcance_final.label,
    short_label: QUOTATION_BOARD_STATE_CONFIG.definir_alcance_final.shortLabel,
    description: QUOTATION_BOARD_STATE_CONFIG.definir_alcance_final.description,
    color_token: 'emerald',
    sort_order: 46,
    is_system: true,
    is_active: true,
